...
// 	$mfinal_name = $mpath;
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("INSERT INTO banners (page_name,banners,mbanner,heading,url) VALUES (?,?,?,?,?)");
		$statement->execute(array($_POST['page_name'],$final_name,$mfinal_name,$_POST['heading'],$_POST['url']));	
