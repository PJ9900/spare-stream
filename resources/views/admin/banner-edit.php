...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {
		...
		$statement = $pdo->prepare("update  banners set page_name=?,banners=?,mbanner=?,heading=?,url=? where id=?");
		$statement->execute(array($_POST['page_name'],$final_name,$mfinal_name,$_POST['heading'],$_POST['url'],$_REQUEST['id']));	
