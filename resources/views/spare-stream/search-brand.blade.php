                                        ...
                                        <center>
                                            @if ($item->images->isNotEmpty())
                                                <a href="{{ route('product.details', ['slug' => $item->slug]) }}">
                                                    <img width="100"
                                                        src="{{ asset('storage/products-images/' . $item->images->first()->image) }}"
        ...
        <section class="content-inner-1">
            <div class="container-fluid">
                ...
                <table class="w-100">
                    <tr>
                        <td style="width: 4%">
                            <a href="search-brand.php">A</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">B</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">C</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">D</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">E</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">F</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">G</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">H</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">I</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">J</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">K</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">L</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">M</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">N</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">O</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">P</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">Q</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">R</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">S</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">T</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">U</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">V</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">W</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">X</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">Y</a>
                        </td>
                        <td style="width: 4%">
                            <a href="search-brand.php">Z</a>
                        </td>
                    </tr>
                </table>
                <div class="bnv">
            ...
            <div class="container-fluid">
                ...
                <div class="row" style="border: 1px solid #ededf5;">
                    ...
                    <div class="col-lg-2 col-md-4 col-sm-4 col-4 text-center p-2">
                        <a href="search-product-type.php">
                            <img
