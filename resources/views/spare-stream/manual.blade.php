...
<div class="container bg-light">
    <div class="row py-5 px-3 justify-content-around">
        ...
        <div class="col-lg-8 mt-3 mt-lg-0">
            <h6 class="fw-bold">How to SpareStream</h6>
            <div class="contact-content">
                <p>Interested in our products? need more information on products and services?
                    ...
                    <ul class="p-0">
                        <li><small class="d-flex align-items-center gap-2"><i class="fa-solid fa-circle" style="font-size:7px"></i> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, sunt!</small></li>
                        <li><small class="d-flex align-items-center gap-2"><i class="fa-solid fa-circle" style="font-size:7px"></i> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, sunt!</small></li>
